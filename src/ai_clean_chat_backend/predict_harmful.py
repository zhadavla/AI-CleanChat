try:
    ...
    def predict_harmfulness(text: str) -> str:
        """
        ...
        inputs = tokenizer_deser(text, return_tensors='pt', truncation=True, padding='max_length', max_length=32)
        ...
        return label_map[predicted_classes[0]]

except Exception as e:
    print(f"An error occurred: {e}")
    print("Using a mock function instead.")
